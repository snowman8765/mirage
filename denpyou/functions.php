...
function calc(){
  ...
  switch(hour) {
    case 8: nomihoudai = <?php echo NOMIHOUDAI_8;?>;break;
    case 9: nomihoudai = <?php echo NOMIHOUDAI_9;?>;break;
    case 10: nomihoudai = <?php echo NOMIHOUDAI_10;?>;break;
    case 11: nomihoudai = <?php echo NOMIHOUDAI_11;?>;break;
    case 12: nomihoudai = <?php echo NOMIHOUDAI_12;?>;break;
    default: nomihoudai = <?php echo NOMIHOUDAI_00;?>;
  }
  ...
  $("select.simei option:selected").each(function(){
    var simei = $(this).val();
    if(simei != 0) {
      simei_sum += <?php echo HON_SIMEI_TANKA;?>;
    }
  });
  ...
  var chg = Number($("input#chg").val())*<?php echo CHARGE_TANKA;?>;
  var vip = Number($("input#vip").val());
  var order_kei = Number($("input#order_kei").val());
  var syoukei = party*ninzuu + chg + vip + simei_sum + order_kei;
  var zei = 0;
  if($("input#party").val() > 0) {
    zei = (chg + vip + simei_sum + order_kei) * <?php echo ORDER_TAX;?>;
  } else {
    zei = syoukei * <?php echo ORDER_TAX;?>;
  }
